...
var app = (function () {
    ...
    var MainTs = {
        ...
        async requetNewsListEvent() {
            try {
                const { body: reoslve } = await superagent.get("http://localhost:3000/test");
    ...
    const file$1 = "src\\components\\list_itme\\listItem.svelte";
    ...
    function create_fragment$2(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(img, file$1, 13, 4, 390);
    			add_location(p0, file$1, 15, 6, 500);
    			add_location(p1, file$1, 16, 6, 522);
    			attr_dev(div0, "class", "item_box--title");
    			add_location(div0, file$1, 14, 4, 463);
    			attr_dev(div1, "class", "item_box--child");
    			add_location(div1, file$1, 12, 2, 355);
    			attr_dev(div2, "class", "item_box");
    			add_location(div2, file$1, 11, 0, 329);
    		},
    		l: function claim(nodes) {
    ...
    class ListItem extends SvelteComponentDev {
    	constructor(options) {
    		super(options);
    		init(this, options, instance$2, create_fragment$2, safe_not_equal, { imagePath: 0, title: 1, resTime: 2 });
    ...
    const file = "src\\pages\\main\\main.svelte";
